...
xi.settings.main =
{
    ...
    DIVINE_POWER    = 1.750, -- Multiplies damage dealt by Divine Magic.
    ...
    CHOCOBO_RAISING_GIL_MULTIPLIER      = 2.0,   -- float. Multiplier for gil recieved through chocobo actions (care plans, etc.). Default 1.0.
